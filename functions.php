<?php
/**
 * blog_indive functions and definitions
 *
 ...
 */
function blog_indive_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on blog_indive, use a find and replace
		* to change 'blog_indive' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'blog_indive', get_template_directory() . '/languages' );
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'blog_indive_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'blog_indive_setup' );
 ...
 */
function blog_indive_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'blog_indive_content_width', 640 );
}
add_action( 'after_setup_theme', 'blog_indive_content_width', 0 );
 ...
 */
function blog_indive_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'blog_indive' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'blog_indive' ),
...
add_action( 'widgets_init', 'blog_indive_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function blog_indive_scripts() {
...
add_action( 'wp_enqueue_scripts', 'blog_indive_scripts' );
